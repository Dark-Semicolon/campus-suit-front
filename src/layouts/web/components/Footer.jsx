...
function Footer() {
  ...
  return (
    <footer className="flex flex-wrap items-center justify-between gap-3 px-2 py-8 bg-black md:px-16">
      <p className="text-gray-500">All Rights Reserved CampusSuite.com 2024</p>
