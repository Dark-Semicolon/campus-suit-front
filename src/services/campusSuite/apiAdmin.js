...
export async function getAllAdmins({ filter, fields, load, include, searchValue, filterAndSortAndPageQuery, sortBy, page = 1, perPage = 10 }) {
  await csrf();
...
export async function UpdateAdmin({ adminId, image, name, email, password, passwordConfirmation, status }) {
  await csrf();
