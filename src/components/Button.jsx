...
function Button({
    ...
    const styles = {
        primary:
            base +
            ` px-4 py-2 md:px-6 bg-blue-color-light text-white  ${className}`,
        ...
        simple: `text-sm font-semibold px-[12px] py-[8px] bg-blue-color-light text-white rounded-md min-w-[140px] ${className}`,
    };
