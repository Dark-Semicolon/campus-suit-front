...
import { useFacultySupervisorPermissions } from "../../facultySupervisor/hooks/useFacultySupervisorPermissions";
import { useFacultySupervisorRoles } from "../../facultySupervisor/hooks/useFacultySupervisorRole";
import ViewFacultySupervisor from "../../facultySupervisor/components/ViewFacultySupervisor";
...
function FacultiesTable() {
    ...
    const totalPages = Math.ceil(
        faculties?.meta?.total / faculties?.meta?.per_page
    );
