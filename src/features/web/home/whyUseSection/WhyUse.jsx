    ...
    <section className="relative py-16 md:py-32">
      ...
      <div className="container flex flex-col items-center justify-center mx-auto">
        <header className="mb-10 text-center">
          <h2 className="pb-3 text-3xl font-bold tracking-wide md:text-6xl text-blue-color-light">Why To choose</h2>
          <p className="text-2xl font-semibold md:text-3xl text-blue-color-primary">CampusSuite</p>
        </header>
